...
class Interest
{
   ...
   // static var listy: [Interest] = []
    ...
    {
//       listy.append(Interest(title: "Amulya Parmar, 15862588588, parmar.amulya@gmail.com", featuredImage: UIImage(named: "f1")!, color: UIColor(red: 63/255.0, green: 71/255.0, blue: 80/255.0, alpha: 0.8)))
//        return listy
        return carouselList
//        return [
//            Interest(title: "Amulya Parmar, 15862588588, parmar.amulya@gmail.com", featuredImage: UIImage(named: "f1")!, color: UIColor(red: 63/255.0, green: 71/255.0, blue: 80/255.0, alpha: 0.8)),
